Документация к программе task3-createdbmsexel-on-msworddocfiles.

1. Установка.

Для установки программы необходимо распаковать архив task3-createdbmsexel-on-msworddocfiles-1.0-bin.zip
...
Для запуска программы используется файл task3-createdbmsexel-on-msworddocfiles.bat